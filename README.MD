...
-Steam API - You can get your own Steam API key from here: https://steamcommunity.com/dev
-Steam ID - You can findout your Steam ID here: https://steamid.io/
Then enter both of these in the Steam Friends Plugin on the DMS settings.
